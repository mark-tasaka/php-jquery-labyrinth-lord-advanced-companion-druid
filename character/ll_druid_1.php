...
<html>
<head>
<title>Labyrinth Lord Druid Character Generator</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Labyrinth Lord Druid Character Generator. Goblinoid Games.">
	<meta name="keywords" content="Labyrinth Lord, Goblinoid Games,HTML5,CSS,JavaScript">
	<meta name="author" content="Mark Tasaka 2018">
		

	<link rel="stylesheet" type="text/css" href="css/ll_druid.css">
	<link rel="stylesheet" type="text/css" href="css/ll_druid_post.css">
...
<body>
    ...
    include 'php/druidSpells.php';
    include 'php/clothing.php';
    include 'php/druidAbilities.php';
    ...
    $vsBreathAttacks = saveBreathAttacks($level);
    $vsPoisonDeath = savePoisonDeath ($level);
    $vsPetrify = savePetrify ($level);
    ...
    $druidSpecialMessage = druidSpecial ($level);
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
      ...
      <span id="primeReq"></span>
       ...
       <span id="druidMessageSpecial">
           <?php
           echo $druidSpecialMessage;
           ?>
       </span>
  ...
  <script>
	...
	/*
	 Character() - Druid Character Constructor
	*/
	function Character() {
        ...
        let	wisdom = rollDice(7, 1, 0, 11);
        let	charisma = <?php echo rand(15, 18) ?>;
		...
		let druidCharacter = {
            ...
            "hp": hitPoints(<?php echo $level ?>, <?php echo $hitDiceOption ?>, constitutionMod),
            "primeReqBonus": primeReq(wisdom, charisma),
	    ...
	    if(druidCharacter.hitPoints <= 0 ){
			druidCharacter.hitPoints = 1;
		}
       ...
       let imgData = "images/druid_character_sheet.png";
