...
<html>
<head>
<title>Launch Page: Labyrinth Lord Druid Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="druidForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Druid</option>
				<option value="2">2nd Level, Druid</option>
				<option value="3">3rd Level, Druid</option>
				<option value="4">4th Level, Druid</option>
				<option value="5">5th Level, Druid</option>
				<option value="6">6th Level, Druid</option>
				<option value="7">7th Level, Druid</option>
				<option value="8">8th Level, Druid</option>
				<option value="9">9th Level, Druid</option>
				<option value="10">10th Level, Druid</option>
				<option value="11">11th Level, Druid</option>
				<option value="12">12th Level, Druid</option>
				<option value="13">13th Level, Druid</option>
				<option value="14">14th Level, Druid</option>
			  </select>
         ...
         <!--   <span class="formIputDescription">Alignment:</span>	
            ...
            <span class="formIputDescription">Shield, wooden:</span>	
			  <select id="shield" name="theShield" class="alignmentBox">			
                <option value="0" selected></option>
				<option value="1">Add Shield (wood)</option>
			  </select>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#druidForm").attr('action', "character/ll_druid_"+ $("#abilityScores").val() +  ".php");
